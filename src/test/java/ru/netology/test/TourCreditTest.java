...
public class TourCreditTest {
    ...
    void allFieldsValid() {
        ...
        tourPage.clickCreditButton().orderTourCredit(ownerCardInfo);
        var creditPage = new CreditPage();
        creditPage.findNotification();
    ...
    void invalidCardNumber() {
        ...
        tourPage.clickCreditButton().orderTourCredit(ownerCardInfo);
        var creditPage = new CreditPage();
        creditPage.findNotificationError();
